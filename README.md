...
### **_Step 10:_** ADD KEY PAIRS
This section is used to define key/value pairs that can be applied to all instances and volumes.
...
use command: ssh ubuntu@ip-address
-	get Jupyter Data Science Notebook image
use command: docker pull jupyter/datascience-notebook
-	Use command docker images to check Jupyter Data Science Notebook image we just pulled
...
CPU	 1	1	2
Memory (GB)	0.5	2	4
Cost/hr	$0.0058 	$0.023 	$0.0464
Cost for 3 months:
90 days * 24 hrs = 2,160 hrs 	$12.528	$49.68	$100.224
